...
#pragma warning(pop)
        ...
        obj_result = BINARY_OPERATION_OBJECT_LONG_DIGIT(operand1->python_value, operand2);
    ...
    exit_result_ok_clong:
        ...
        PyObject *python_result = BINARY_OPERATION_ADD_OBJECT_LONG_DIGIT(operand1->python_value, operand1);
...
bool BINARY_OPERATION_ADD_NILONG_DIGIT_NILONG(nuitka_ilong *result, long operand1, nuitka_ilong *operand2) {
...
#pragma warning(pop)
        ...
        obj_result = BINARY_OPERATION_OBJECT_DIGIT_LONG(operand1, operand2->python_value;
...
exit_result_ok_clong:
        ...
        PyObject *python_result = BINARY_OPERATION_ADD_DIGIT_LONG(operand1, operand1->python_value);
